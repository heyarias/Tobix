			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form action= "ServletRActividad" method="get">
					...
					<div class="wrap-input100 validate-input m-b-23" >
						<span class="label-input100">Registrar Administador </span>
						<div class="" align="center"><a href="registroAdministrador.jsp"> Administrador</div>
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>

					<div class="wrap-input100 validate-input" >
						<span class="label-input100">Registrar Bloque</span>		
						<div class="" align="center"><a href="addBloque.jsp">Bloque</div>						
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
					
					<div class="wrap-input100 validate-input" >
						<span class="label-input100">Registrar Actividad</span>		
						<div class="" align="center"><a href="addActivity.jsp">Actividad</div>						
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
