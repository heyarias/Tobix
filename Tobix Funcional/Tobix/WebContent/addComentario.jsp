...
<div class="wrap-input100 validate-input" data-validate="edition is required">
				...
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					...
					<input class="input100" type="text" id="comentario" name = "comentario" >
					<span class="focus-input100"></span>
				</div>
			<div align= "center"><br><input type="submit" class="button" value="Enviar Comentario" style="width: 154px; "><br></div>
			</form>
