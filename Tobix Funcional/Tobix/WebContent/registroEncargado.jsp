...
<body>
	...
	<div class="container-contact100">
		...
		<form action= "ServletRegistroEncargado" method="get">
				...
				<div class="wrap-input100 validate-input" data-validate="field is required">
					<span class="label-input100">Years</span>
					<input class="input100" id="anios" name = "anios" placeholder="Institucion"></input>
					<span class="focus-input100"></span>	
				<div class="container-contact100-form-btn">
					<div class="wrap-contact100-form-btn">
						<div class="contact100-form-bgbtn"></div>
						<div align= "center"><br><input type="submit" class="button" value="Registrar Encargado" style="width: 154px; "><br></div>
					</div>
				</div>
